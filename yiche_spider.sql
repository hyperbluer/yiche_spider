...
) ENGINE=InnoDB AUTO_INCREMENT=4442 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
CREATE TABLE `base_yiche_car_brand` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_third_id` (`third_id`)
) ENGINE=InnoDB AUTO_INCREMENT=456 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=88123 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=52679 DEFAULT CHARSET=utf8mb4;
